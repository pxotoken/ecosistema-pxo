...
// ============================================================================
// Tipo legado (mantenido temporalmente — se elimina al cerrar Fase 3 ADR 0002)
// ============================================================================

/**
 * @deprecated Usar `KycSubmission`. Eliminar al completar la migración legacy → api-kyc.
 */
