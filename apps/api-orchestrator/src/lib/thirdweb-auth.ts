...
if (!env.THIRDWEB_ADMIN_PRIVATE_KEY) throw new Error('Missing THIRDWEB_ADMIN_PRIVATE_KEY');
if (!env.THIRDWEB_CLIENT_ID) throw new Error('Missing VITE_THIRDWEB_CLIENT_ID');
if (!env.THIRDWEB_AUTH_DOMAIN) throw new Error('Missing VITE_THIRDWEB_AUTH_DOMAIN');
