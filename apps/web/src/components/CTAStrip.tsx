      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          <motion.h3
            ...
            className="text-xl font-bold text-pxo-primary font-editorial"
          >
          ...
          >
            <div className="flex items-center space-x-2 bg-light-glass dark:bg-dark-glass px-3 py-2 rounded-full transition-colors duration-300">
              <div className="flex items-center">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 text-pxo-primary fill-current" />
                ))}
              </div>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 bg-light-glass dark:bg-dark-glass border border-light-border dark:border-dark-border px-4 py-2 rounded-xl hover:border-pxo-primary/30 transition-all duration-300"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 bg-pxo-primary text-white px-4 py-2 rounded-xl font-medium hover:shadow-glow transition-all"
          >
