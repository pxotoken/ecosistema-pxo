      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-16 md:space-y-12 md:flex md:flex-col md:items-center">
          {howItWorks.map((step, index) => (
            <motion.div
              key={step.step}
              initial={{ y: 100, opacity: 0, scale: 0.9 }} // Más desplazamiento, ligeramente más pequeña
              whileInView={{ y: 0, opacity: 1, scale: 1 }} // Vuelve a su tamaño normal
              transition={{ duration: 0.6, delay: index * 0.15, ease: "easeOut" }} // Transición más rápida, retraso ajustado, easing
              viewport={{ once: true, amount: 0.4 }} // Se activa cuando el 40% de la tarjeta está visible
            ...
            >
              {/* Icon Area (without step number circle) */}
