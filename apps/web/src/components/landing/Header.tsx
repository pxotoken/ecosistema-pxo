...
import { ConnectWalletButton } from '../crypto';
      ...
      {isMenuOpen && (
        ...
        >
          <nav className="flex flex-col items-center space-y-4">
            ...
            <button 
              onClick={toggleMenu}
              className="focus:outline-none focus:ring-2 focus:ring-pxo-primary focus:ring-offset-2 rounded-lg"
              aria-label="Close menu and connect wallet"
            >
              <ConnectWalletButton variant="primary" />
            </button>
          </nav>
