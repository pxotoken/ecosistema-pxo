...
/**
 * Sell PXO chooser — portaled modal, mirrors BuyOptionsModal in structure.
 * Reachable from the balance-card Sell button.
 */
export function SellOptionsModal({ open, onClose }: SellOptionsModalProps) {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="sell-options-title"
      onClick={onClose}
    >
      <div
        ...
        <div className="px-4 py-4 overflow-y-auto space-y-6">
          <section>
            ...
            <OptionRow
              ...
              name="Wallet Balance"
              description="Sell PXO to your Digital Dollar balance in your wallet."
              tags={['Zero-fee', 'Immediate']}
              onSelect={() => handleSelect(PATHS.dashboard.exchangeSell)}
            />
          </section>
          ...
          <section>
            ...
            <OptionRow
              ...
              name="SPEI"
              description="Withdraw MXN to your bank account."
              tags={['Zero-fee', 'Up to 24h']}
              onSelect={() => handleSelect(PATHS.dashboard.fiatRedeem)}
            />
          </section>
        </div>
      </div>
